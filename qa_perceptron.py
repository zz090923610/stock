...
def save_perceptron_data_for_stock(stock, data_list):
    subprocess.call("mkdir -p ../stock_data/qa/perceptron", shell=True)
    with open('../stock_data/qa/perceptron/%s.pickle' % stock, 'wb') as f:
...
class Perceptron:
    ...
    def save_weights(self):
        ...
        with open('../stock_data/qa/perceptron_params/params.pickle', 'wb') as f:
