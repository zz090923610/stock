...
def get_credentials():
    ...
    credential_dir = os.path.join(stock_data_root, 'gmail_credentials')
...
def load_plot_list():
    with open('%s/plots/plot_list.pickle' % stock_data_root, 'rb') as f:
...
def create_message_with_attachment(
    ...
    for attachment in files:
        print(attachment)
        fp = open('%s/plots/%s' % (stock_data_root, attachment), 'rb')
