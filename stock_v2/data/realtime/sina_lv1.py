...
def parse_one_line(line):
    try:
        ...
        final_dict['turnover'] = float(final_dict['volume'])/(float(BASIC_INFO.outstanding_dict[final_dict['code']])*1000000)
...
class RTPrice(DaemonClass):
    ...
    def get_stock_rtp_batch(self):
        ...
        new_list = [monitoring_list[i:i + 200] for i in range(0, len(monitoring_list), 200)]
        for monitoring_list in new_list:
            stock_list = []
